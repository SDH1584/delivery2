...
public class PointController {
	...
	public String point(Model model, HttpSession session) {
		...
		int allPoint = pointService.getAllPoint(no);
		model.addAttribute("allPoint", allPoint);
		System.out.println(allPoint);
		int validityPoint = pointService.getValidityPoint(no);
		model.addAttribute("validityPoint", validityPoint);
		System.out.println(validityPoint);
